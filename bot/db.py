...
def _reconcile_incompatible(con) -> None:
    ...
    created by a DIFFERENT app sharing this database (e.g. ARC or an old bot
    using 'id' instead of 'user_id'). Rename it aside — data preserved — so
    the correct schema can be created; otherwise every query on that table
    ...
    suffix = f"pre_deluge_{int(_time.time())}"
